          ...
          <div className="container">
            <div className="seoBlock__inner" data-aos="fade-up">
              ...
              <div className="seoBlock__text">
                <p>
                  Dent Clinic — современная стоматология в Бишкеке, где мы заботимся
                  о здоровье и красоте вашей улыбки. Наша клиника предлагает полный
                  спектр стоматологических услуг: лечение кариеса, профессиональная
                  чистка зубов, отбеливание, удаление и протезирование.
                </p>
                <p>
                ...
                <p>
                  ...
                  комфортной атмосферой и честными ценами — запишитесь на консультацию
                  через WhatsApp или по телефону. Dent Clinic — это качество,
                  доверие и забота о вашем здоровье.
                </p>
              </div>
            </div>
          </div>
